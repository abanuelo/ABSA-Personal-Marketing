...
def main(sentence, keyword, path): 
    ...
    model_state_dict_paths = {
        'atae_lstm': path + 'state_dict/atae_lstm_abs_val_acc0.4314',
    ...
    test_path = ''
    if len(path) > 0:
        train_path = path + 'datasets/semeval14/ABS_Train.xml.seg'
        test_path = path + 'datasets/semeval14/ABS_Test_Gold.xml.seg'
    else:
        train_path = './datasets/semeval14/ABS_Train.xml.seg'
        test_path = './datasets/semeval14/ABS_Test_Gold.xml.seg'
    opt.dataset_file = {
        'train': train_path,
        'test': test_path
    }
