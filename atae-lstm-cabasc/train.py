...
def main():
    ...
    dataset_files = {
        ...
        'abs' : {
            'train': './datasets/semeval14/ABS_Train.xml.seg',
            'test': './datasets/semeval14/ABS_Test_Gold.xml.seg'
        },
        'airbag' : {
            'train': './datasets/semeval14/Airbag_Train.xml.seg',
            'test': './datasets/semeval14/Airbag_Test_Gold.xml.seg'
        }, 
        'airconditioner' : {
            'train': './datasets/semeval14/AirConditioner_Train.xml.seg',
            'test': './datasets/semeval14/AirConditioner_Test_Gold.xml.seg'
        }, 
        'balljoint' : {
            'train': './datasets/semeval14/Balljoint_Train.xml.seg',
            'test': './datasets/semeval14/Balljoint_Test_Gold.xml.seg'
        }, 
        'cabinairfilter' : {
            'train': './datasets/semeval14/CabinAirFilter_Train.xml.seg',
            'test': './datasets/semeval14/CabinAirFilter_Test_Gold.xml.seg'
        }, 
        'oil' : {
            'train': './datasets/semeval14/Oil_Train.xml.seg',
            'test': './datasets/semeval14/Oil_Test_Gold.xml.seg'
        }
    }
    input_colses = {
