...
def main(sentence, keyword, path): 
    ...
    model_state_dict_paths = {
        'atae_lstm': path + 'state_dict/atae_lstm_airconditioner_val_acc0.6124',
    ...
    opt.dataset = 'airconditioner'
    train_path = ''
    test_path = ''
    if len(path) > 0:
        train_path = path + 'datasets/semeval14/AirConditioner_Train.xml.seg'
        test_path = path + 'datasets/semeval14/AirConditioner_Test_Gold.xml.seg'
    else:
        train_path = './datasets/semeval14/AirConditioner_Train.xml.seg'
        test_path = './datasets/semeval14/AirConditioner_Test_Gold.xml.seg'
    opt.dataset_file = {
        'train': train_path,
        'test': test_path
    }
