...
class Inferer:
    ...
    def evaluate(self, raw_texts):
        ...
        aspect_seqs = [self.tokenizer.text_to_sequence('mount and balance')] * len(raw_texts) #can put 'null' as a catch all statement
...
if __name__ == '__main__':
    ...
    model_state_dict_paths = {
        'atae_lstm': 'state_dict/atae_lstm_restaurant_val_acc0.8541',
    ...
    inf = Inferer(opt)
    t_probs = inf.evaluate([' Declined Mount and balance 2 new front tires.'])
